    ...
    createCinema(formData, {
      onSuccess: () => {
        ...
        toast.success("Thêm rạp chiếu thành công", {
          description: "Rạp mới đã được lưu vào hệ thống.",
        });
        methods.reset();
        setPreviewImage(null);
        refetchCinemas();
      ...
      onError: (error: any) => {
        toast.error("Thêm rạp chiếu thất bại", {
          description: error?.message || "Không thể tạo rạp mới lúc này.",
        });
      },
    });
  };
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1.5 text-sm font-medium text-zinc-500">
                  Điền thông tin cơ bản và tải ảnh đại diện cho rạp chiếu mới.
                </p>
              </div>
